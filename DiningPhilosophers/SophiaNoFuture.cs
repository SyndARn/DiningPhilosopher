...
namespace SophiaNoFuture
{
    ...
    //        AddBehavior(new Behavior<IActor, bool>(DoClaim));
    //    }
    ...
    //    private void DoClaim(IActor actor, bool claim)
    //    {
    //        if (claim)
    //        {
    //            if (InHand == null)
    ...
    //                InHand = actor;
    //            }
    //            actor.SendMessage(InHand == actor);
    //        }
    //        else
    //        {
    //            if (InHand == actor)
    ...
    //    public void Claim(IActor actor, bool claim)
    //    {
    //        this.SendMessage(actor, claim);
    //    }
    ...
    //    private int ForksInHand { get; set; }
